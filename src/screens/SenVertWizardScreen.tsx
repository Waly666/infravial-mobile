...
const styles = StyleSheet.create({
  ...
  loadTxt: { marginTop: 8, color: '#546e7a' },
  progress: { padding: 10, backgroundColor: '#f3e5f5' },
  progressTxt: { fontWeight: '700', color: '#6a1b9a' },
  scroll: { flex: 1 },
  scrollPad: { padding: 16, paddingBottom: 28 },
  h2: { fontSize: 18, fontWeight: '700', color: '#311b92', marginBottom: 6 },
  sub: { fontSize: 13, color: '#546e7a', marginBottom: 12 },
  block: { marginBottom: 12 },
  lbl: { fontSize: 13, fontWeight: '600', color: '#37474f', marginBottom: 6 },
  section: { fontSize: 15, fontWeight: '700', color: '#4a148c', marginTop: 16, marginBottom: 8 },
  inp: {
    borderWidth: 1,
    borderColor: '#cfd8dc',
    borderRadius: 8,
  ...
  chipOn: { backgroundColor: '#6a1b9a' },
  chipTxt: { fontSize: 11, color: '#37474f' },
  ...
  tramoMain: { fontSize: 17, fontWeight: '700', color: '#4a148c' },
  tramoSub: { fontSize: 14, color: '#6a1b9a', marginTop: 4 },
  ...
  dropSub: { fontSize: 12, color: '#78909c' },
  gpsBtn: { backgroundColor: '#7b1fa2', padding: 14, borderRadius: 10, alignItems: 'center', marginBottom: 12 },
  gpsTxt: { color: '#fff', fontWeight: '700' },
  dis: { opacity: 0.5 },
  senCard: { backgroundColor: '#fff', padding: 12, borderRadius: 10, borderWidth: 1, borderColor: '#ce93d8' },
  senImg: { width: '100%', height: 140, marginBottom: 8 },
  senCod: { fontSize: 16, fontWeight: '700', color: '#4a148c' },
  senDesc: { fontSize: 14, color: '#455a64' },
  secBtn: { borderWidth: 1, borderColor: '#7b1fa2', padding: 14, borderRadius: 10, alignItems: 'center', marginBottom: 12 },
  secBtnTxt: { color: '#7b1fa2', fontWeight: '700' },
  pickBtn: { borderWidth: 1, borderColor: '#90a4ae', borderRadius: 8, padding: 12, backgroundColor: '#fff' },
  pickTxt: { fontSize: 14, color: '#263238' },
  fotoPrev: { width: '100%', height: 180, borderRadius: 8, marginBottom: 10, backgroundColor: '#ede7f6' },
  camBtn: { backgroundColor: '#4527a0', padding: 14, borderRadius: 10, alignItems: 'center' },
  camBtnTxt: { color: '#fff', fontWeight: '700' },
  warnLink: { color: '#c62828', marginTop: 8, fontWeight: '600' },
  footer: { flexDirection: 'row', gap: 10, padding: 12, borderTopWidth: 1, borderColor: '#e0e0e0', backgroundColor: '#fff' },
  navBtn: { flex: 1, padding: 14, alignItems: 'center', borderRadius: 10, borderWidth: 1, borderColor: '#b39ddb' },
  navPri: { flex: 1, padding: 14, alignItems: 'center', borderRadius: 10, backgroundColor: '#6a1b9a' },
  navPriTxt: { color: '#fff', fontWeight: '700' },
  modalBg: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
  modalBox: { backgroundColor: '#fff', borderTopLeftRadius: 16, borderTopRightRadius: 16, padding: 16, maxHeight: '88%' },
  modalTit: { fontSize: 17, fontWeight: '700', marginBottom: 10, color: '#311b92' },
  modalClose: { alignSelf: 'flex-end', marginBottom: 8 },
  galRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderColor: '#f0f0f0', gap: 10 },
  galThumb: { width: 56, height: 56, borderRadius: 6 },
  galPh: { backgroundColor: '#e1bee7' },
  galCod: { fontWeight: '700', color: '#4a148c' },
  galDesc: { fontSize: 12, color: '#546e7a' },
});
